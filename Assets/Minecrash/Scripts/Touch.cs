...
public class Touch : MonoBehaviour
{
    ...
    void addSelectEffect(GameObject obj)
    {
        ...
        if (obj != null)
        {
            ...
            GameObject tmp = Instantiate(selectEffect) as GameObject;
            tmp.name = selectEffect.name;
            tmp.transform.parent = PlayingUI.transform.GetChild(0);
