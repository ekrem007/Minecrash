...
public class Jewel : MonoBehaviour
{
    ...
    void MoveToX(float x)
    {
        ...
        else
        {
            ...
            if (type == 99)
                if (WinChecker())
                {
                    GameObject.Find("Main Camera").GetComponent<Menu>().Win();
                }
        }
    }
    ...
    IEnumerator destroy()
    {
        ...
        if (type < 99)
        {
            ...
            {
                FindObjectOfType<Sound>().blockCrash(type);
            }
    ...
    bool PowerProcess(int power)
    {
        ...
        switch (power)
        {
            ...
            case 1:
                //boom
                Effect.SpawnBoom(new Vector2(mtransform.position.x, mtransform.position.y), effect[2], 1);
