...
public class Cell : MonoBehaviour
{
    ...
    public void RemoveCellEffect()
    {
        ...
        if (Type > 10)
        {
            ...
            if (s == 4)
            {
                ...
                {
                    FindObjectOfType<Sound>().lockcash();
                }
            }
            else
            {
                if (FindObjectOfType<Sound>() != null)
                {
                    FindObjectOfType<Sound>().icecash();
                }
            }
    ...
    void CellEffectAdd()
    {
        if (Type > 10)
        {
            ...
            tmp.transform.localPosition = new Vector3(0, 0, -0.2f);
            if (Type % 10 == 5)
                tmp.transform.localScale = new Vector3(0.4f, 0.4f, 1);
